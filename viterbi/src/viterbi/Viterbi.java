 ...
 */
	...
	private static String[] states = { "1", "2", "3" };
	private static String[] observations = { "U", "U", "V" };
	private static double[] start_probability = { 0.2, 0.3, 0.5 };
	private static double[][] transition_probability = { { 0.3, 0.3, 0.3 },
			{ 0.0, 0.4, 0.4 }, { 0.0, 0.3, 0.3 } };
	private static double[][] emission_probability = { { 0.5, 0.5, 0.5 },
	...
	public int[] forwardViterbi(String[] y, String[] X, double[] sp,
		...
		System.out.print("OPTIMAL STATE SEQUENCE-Viterbi path: [");
